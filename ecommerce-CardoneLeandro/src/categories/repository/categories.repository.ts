...
@Injectable()
export class CategoriesRepository extends Repository<Category> { //here declarate the repository as "CategoriesRepository" as an extension of the class "Repository" with the entity "Category"
...
async getCategories(): Promise<Category[]> { // here call the method "find" on this repository 
